package com.emekamomodu.googlefoobar.stage4challenge2;
 ...
 *
 * The room has integer dimensions [1 < x_dim <= 1250, 1 < y_dim <= 1250]. You and the elite trainer are both positioned on
 ...
 * elite trainer (given as vector bearings from your location): [1, 0], [1, 2], [1, -2], [3, 2], [3, -2], [-3, 2], and
 * [-3, -2]. As specific examples, the shot at bearing [1, 0] is the straight line horizontal shot of distance 1, the shot
 * at bearing [-3, -2] bounces off the left wall and then the bottom wall before hitting the elite trainer with a total
 * shot distance of sqrt(13), and the shot at bearing [1, 2] bounces off just the top wall before hitting the elite trainer
